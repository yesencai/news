...
+(void)searchColumn:(id)columns where:(id)where orderBy:(NSString*)orderBy offset:(NSInteger)offset count:(NSInteger)count callback:(void (^)(NSMutableArray* array))block;


+ (NSMutableArray*)searchWithWhere:(id)where orderBy:(NSString*)orderBy offset:(NSInteger)offset count:(NSInteger)count;
+(void)searchWithWhere:(id)where orderBy:(NSString*)orderBy offset:(NSInteger)offset count:(NSInteger)count callback:(void (^)(NSMutableArray* array))block;

+ (NSMutableArray*)searchWithWhere:(id)where;
+(void)searchWithWhere:(id)where callback:(void (^)(NSMutableArray* array))block;

+ (NSMutableArray*)searchWithSQL:(NSString*)sql;
+(void)searchWithSQL:(NSString*)sql callback:(void (^)(NSMutableArray* array))block;

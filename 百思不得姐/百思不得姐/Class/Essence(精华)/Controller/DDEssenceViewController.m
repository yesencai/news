...
#import "DDVedioTableViewController.h"
#import "DDVioceTableViewController.h"
#import "DDPictureTableViewController.h"
#import "DDWordTableViewController.h"
...
- (void)setupChildViewController{
    ...
    DDVedioTableViewController *video = [[DDVedioTableViewController alloc]init];
    [self addChildViewController:video];

    DDVioceTableViewController *voice = [[DDVioceTableViewController alloc]init];
    [self addChildViewController:voice];

    DDPictureTableViewController *picture = [[DDPictureTableViewController alloc]init];
    [self addChildViewController:picture];
    DDWordTableViewController *word = [[DDWordTableViewController alloc]init];
...
-(void)clickTag{
    DDRemTagTableViewController *tag = [[DDRemTagTableViewController alloc]init];

...
@interface DDReccmmendCell()
/**
 *  选择cell红色部分
 */
@property(nonatomic,strong)UIView *selectedView;
@end
@implementation DDReccmmendCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    DDReccmmendCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[self alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
    return cell;
}
-(void)setReccmmend:(DDReccmmend *)reccmmend{

...
@end
@implementation DDReccmmendUserCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *ID = @"DDReccmmendUserCell";
    DDReccmmendUserCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[self alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
    return cell;
}
-(void)setUser:(DDReccmmendUser *)user{
    _user = user;
